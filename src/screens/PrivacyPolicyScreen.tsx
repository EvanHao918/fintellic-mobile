      ...
      >
        <View style={styles.introduction}>
          <Text style={styles.introText}>
            AllSight is committed to protecting your privacy. This Privacy Policy explains 
        ...
        {renderSection(
          ...
          "• Provide and maintain AllSight services\n" +
        ...
        {renderSection(
          ...
          "To exercise these rights, contact us at support@allsight.app"
        )}
        ...
        {renderSection(
          ...
          "AllSight is not intended for users under 18. We do not knowingly collect data from children. If we discover we have collected such data, we will delete it promptly."
        )}
        ...
        {renderSection(
          ...
          "Contact us at support@allsight.app to exercise these rights."
        )}
        ...
        {renderSection(
          ...
          "Contact us at support@allsight.app for assistance."
        )}
        ...
        {renderSection(
          ...
          "Privacy Team: support@allsight.app\n" +
          "Support: support@allsight.app\n\n" +
          "Legal Entity: AllSight\n" +
